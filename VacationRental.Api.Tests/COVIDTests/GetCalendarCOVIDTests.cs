...
namespace VacationRental.Api.Tests
{
    ...
    public class GetCalendarCOVIDTests
    {
        private readonly HttpClient _client;

        public GetCalendarCOVIDTests(IntegrationFixture fixture)
        {
        ...
        public async Task GivenCompleteRequest_WhenGetCalendar_ThenAGetReturnsTheCalculatedCalendar()
        {
            ...
            using (var getCalendarResponse = await _client.GetAsync($"/api/v1/calendar?rentalId={postRentalResult.Id}&start=2000-01-01&nights=6"))
            {
                ...
                Assert.Contains(getCalendarResult.Dates[3].PreparationTimes, x => x.Unit == getCalendarResult.Dates[2].Bookings[0].Unit);
                ...
                Assert.Contains(getCalendarResult.Dates[4].PreparationTimes, x => x.Unit == getCalendarResult.Dates[3].Bookings[0].Unit);
